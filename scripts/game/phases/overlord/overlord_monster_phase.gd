...
func _select_next_monster_group():
	...
	Utils.connect_signal(_monster_group_gui, "avatar_clicked", self, "_start_monster_group_turn", [], CONNECT_ONE_SHOT)
...
func _start_monster_group_turn(group):
	...
	sub_phase.connect("monster_group_completed", Callable(self, "_monster_group_completed"))
